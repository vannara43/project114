...
//  }
  ...
  return (
    ...
    <button onClick={getAllCheckout} className="btn btn-primary">Get Checkouts</button>

    {/* Get Cards */}
    <div className="row">
      {state.map((data, index)=>{
        return(
          <div className="card shadow col-2 m-1"
          style={{ width: "18rem" }}
          key={index}>
            <div className="card-body">
                  <img className="card-img-top" alt="basket_image.jpg" src={checkoutImage}/>
